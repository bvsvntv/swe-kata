...
type Querier interface {
	...
	FetchCustomerPayments(ctx context.Context, arg FetchCustomerPaymentsParams) ([]Payment, error)
	FetchCustomerRentals(ctx context.Context, arg FetchCustomerRentalsParams) ([]Rental, error)
	...
	FetchStaffPayments(ctx context.Context, arg FetchStaffPaymentsParams) ([]Payment, error)
